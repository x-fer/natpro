module.exports = {
  materijaliSidebar: {
    ...
    '3. Potpuno pretraživanje i pohlepni pristupi': ['uvod', 'meet-in-the-middle', 'pruning', 'zadatci-potpuno', 'pohlepni-pristupi'].map(title => 'potpuno-pretrazivanje-i-pohlepni-pristupi/' + title),
