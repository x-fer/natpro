module.exports = {
  materijaliSidebar: {
    ...
    'Potpuno pretraživanje i pohlepni pristupi': ['uvod', 'podskupovi', 'permutacije', 'pretrazivanje-unatrag', 'skracivanje-pretrazivanja', 'meet-in-the-middle', 'primjeri'].map(title => 'potpuno-pretrazivanje-i-pohlepni-pristupi/' + title),
