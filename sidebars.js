module.exports = {
  materijaliSidebar: {
    ...
    '4. Dinamičko programiranje': ['sto-je-dinamicko-programiranje', 'problem-razmjene-novca', 'najdulji-rastuci-podniz', 'knapsack', 'primjeri'].map(title => 'dinamicko-programiranje/' + title),
